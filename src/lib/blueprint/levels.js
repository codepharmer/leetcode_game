...
const BASE_BLUEPRINT_LEVELS = [
  {
    ...
    cards: [
      ...
      {
        id: "1-c4",
        text: "for (let right = 0; right < nums.length; right++)",
        correctSlot: "loop",
        correctOrder: 0,
        key: "for-right",
        hint: "Loop",
  ...
  },
  {
    ...
    cards: [
      ...
      { id: "2-c4", text: "for (let right = 0; right < s.length; right++)", correctSlot: "loop", correctOrder: 0, key: "for-right" },
      {
        id: "2-c5",
      ...
      { id: "2-c6", text: "seen.add(s[right])", correctSlot: "update", correctOrder: 1, key: "add-seen" },
      {
        id: "2-c7",
        text: "maxLen = Math.max(maxLen, right - left + 1)",
        correctSlot: "check",
        correctOrder: 0,
        key: "update-maxlen",
      },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: "3-c5", text: "if (sum === target) {\n  return [left, right]\n}", correctSlot: "compare", correctOrder: 0, key: "found" },
