...
export const S = {
  ...
  blueprintSlotCards: { display: "flex", alignItems: "center", minWidth: 0, padding: "0 10px", width: "100%" },
  blueprintSlotEmpty: { width: "100%", display: "flex", alignItems: "center", gap: 8, minWidth: 0, lineHeight: 1.2 },
  blueprintDropPlus: { marginLeft: "auto", fontSize: 18, fontFamily: FONTS.mono, fontWeight: 700, lineHeight: 1, flexShrink: 0 },

  blueprintSlotFilledRow: { width: "100%", minWidth: 0, display: "flex", alignItems: "center", gap: 6 },
  blueprintPlacedInlineMask: {
    display: "flex",
    alignItems: "center",
    minWidth: 0,
    flex: 1,
  ...
  blueprintPlacedRow: { display: "inline-flex", alignItems: "center", gap: 6, flexShrink: 0 },
  blueprintInlineSeparator: { color: C.dim, fontFamily: FONTS.mono, fontSize: 10.5, letterSpacing: "0.04em" },
  blueprintPlacedCard: {
    background: "none",
    border: "none",
    padding: 0,
  ...
  blueprintDeckArea: {
    ...
    background: "linear-gradient(180deg, rgba(10, 10, 18, 0) 0%, rgba(10, 10, 18, 0.92) 18%, rgba(10, 10, 18, 0.98) 100%)",
    zIndex: 1090,
  },
  blueprintDeckHeaderRow: { width: "100%", maxWidth: 920, margin: "0 auto 6px", display: "flex", justifyContent: "space-between", alignItems: "center" },
